...
(cl:in-package ourSensor_msgs-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Accel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Accel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ourSensor_msgs-msg:<Accel> is deprecated: use ourSensor_msgs-msg:Accel instead.")))

(cl:ensure-generic-function 'accel1_x-val :lambda-list '(m))
(cl:defmethod accel1_x-val ((m <Accel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ourSensor_msgs-msg:accel1_x-val is deprecated.  Use ourSensor_msgs-msg:accel1_x instead.")
  (accel1_x m))

(cl:ensure-generic-function 'accel1_y-val :lambda-list '(m))
(cl:defmethod accel1_y-val ((m <Accel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ourSensor_msgs-msg:accel1_y-val is deprecated.  Use ourSensor_msgs-msg:accel1_y instead.")
  (accel1_y m))
